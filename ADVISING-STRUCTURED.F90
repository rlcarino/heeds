...
!======================================================================
    ...
    subroutine checklist_analyze (std, thisTerm, UseClasses, Offering, WaiverCOI, stdScholastic, &
        ...
        !   Group 2 - Graduating (only 30 units or less to earn in curriculum)
    ...
    !        'Allowed='//itoa(AllowedLoad))
        ...
        do idx=1,CheckList%NSubjects
            ...
            !if (is_adviser_of_student(std, orHigherUp) .or. isRoleStudent .or. is_benefactor_of_student(std)) then ! Adviser or SYSAD
