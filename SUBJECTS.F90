...
#include "custom_read_subjects.F90"
    ...
    subroutine xml_write_subjects(path)
        ...
        '        LabFee - how much  (in addn to TUITION) a student will pay if he takes the subject', &
        '        LectHours - no. of lecture hours', &
        '        MinLectSize - minimum size of lecture class', &
        '        MaxLectSize - maximum size of lecture class', &
        '        LabHours - laboratory/recitation/computation class hours; 0 if the subject is lecture-only', &
        '        MinLabSize - minimum size of lab class; 0 if the subject is lecture-only', &
        '        MaxLabSize - maximum size of lab class; 0 if the subject is lecture-only', &
