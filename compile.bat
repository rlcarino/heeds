...
echo g95 -v -o C:\HEEDS\bin\HEEDS-WIN.EXE -Wunused-vars -ftrace=frame -ftrace=full -ffree-form -fbounds-check -DDO_NOT_ENCODE -DWINDOWS -DCUSTOM -ICUSTOM BASE.F90 XML.F90 TIMES.F90 CGI.F90 COLLEGES.F90 DEPARTMENTS.F90 ROOMS.F90 TEACHERS.F90 SUBJECTS.F90 SECTIONS.F90 TIMETABLES.F90 CURRICULA.F90 STUDENTS.F90 GRADES.F90 PRE_ENLISTMENT.F90 CHECKLISTS.F90 BLOCKS.F90 USERFUNCTIONS.F90 HTML.F90 EditSUBJECTS.F90 EditSECTIONS.F90 EditBLOCKS.F90 EditCURRICULA.F90 EditROOMS.F90 EditTEACHERS.F90 EditENLISTMENT.F90 REPORTS.F90 DEMAND.F90 SERVER.F90 MAIN.F90 
